...
TypeSafe AI の判断モデル Jev を Claude Code から使う MCP プラグインです。全 11 ツールを提供します。<br>
判断系のツールで分類・順位付け・主張の確認・操作の安全性評価を行い、ブラウザ系・API 系のツールで動作確認を支援します。API 系のツールは OpenAPI 文書からの操作の列挙と値埋めにも対応します。<br>
