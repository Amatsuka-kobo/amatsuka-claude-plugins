...
- `2026/0712/phyllis998/basic-design-plugin.md` | 2026-07-12 | phyllis998 | 基本設計支援プラグイン「basic-design」の設計ブレインストーミング修正版（4 セッション：HTML インタラクティブ出力・ローカル保存基本・Drive オプトイン設定対応、出力 2 系統・レイアウトエンジン共有、ユーザー承認待機中）
