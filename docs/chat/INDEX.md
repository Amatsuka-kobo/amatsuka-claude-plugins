...
- `2026/0712/phyllis998/basic-design-plugin.md` | 2026-07-12 | phyllis998 | 基本設計支援プラグイン「basic-design」の設計・実装方針策定（5 セッション：HTML インタラクティブ出力・ローカル保存基本・Drive オプトイン、spec スキーマ確定、設計書完成 dc5d14c/a6e9f17、ユーザーレビュー待機中）
