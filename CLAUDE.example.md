...
- SKILL.md の本文・その他の AI 向け指示書は `prompt-smith:prompt-smith` の基準で書くこと。
...
Claude Code only ->
- 最初に必ず `agent-policy:claude-model-policy` スキルを使用し、この規律に従うこと。

With Codex ->
- 最初に必ず `agent-policy:with-codex-policy` スキルを使用し、この規律に従うこと。
-->
