...
# System Architecture — システム構成図の作成

## 目的

ユーザーから与えられた情報を出発点に、ブレインストーミングでゾーン・ノード・通信経路を練り上げ、システム構成図として生成する。
...
- **保存先**: `docs/design/architecture/` を既定として提案し、変更希望を確認する
...
先行する成果物・用語集(入口スキルの概要ブレストなど)がある場合、ノード名・ゾーン名・外部システム名はそれに従う。
