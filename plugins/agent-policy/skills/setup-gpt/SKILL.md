...
```bash
node "${CLAUDE_PLUGIN_ROOT}/scripts/setup-agents.mjs" --vendor gpt --name gpt-sol --model claude-gpt-5-6-sol --roles complex-impl --write --merge
node "${CLAUDE_PLUGIN_ROOT}/scripts/setup-agents.mjs" --vendor gpt --name gpt-terra --model claude-gpt-5-6-terra --roles normal-impl,general,explore,realtime-research,independent-review --write --merge
node "${CLAUDE_PLUGIN_ROOT}/scripts/setup-agents.mjs" --vendor gpt --name gpt-luna --model claude-gpt-5-6-luna --roles light-impl --write --merge
```
...
```bash
node "${CLAUDE_PLUGIN_ROOT}/scripts/setup-agents.mjs" --vendor gpt --name <name> --model <alias> --roles <roles> --write [--merge] [--keep ...]
```
